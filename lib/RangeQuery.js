...
var RangeQuery = function (_React$Component) {
  ...
  function RangeQuery() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (RangeQuery.__proto__ || (0, _getPrototypeOf2.default)(RangeQuery)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(RangeQuery, [{
    ...
    value: function handleChange() {
      ...
      var _ref = [this.start.value, this.end.value],
          start = _ref[0],
          end = _ref[1];
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_QueryInput2.default, (0, _extends3.default)({}, this.props, {
