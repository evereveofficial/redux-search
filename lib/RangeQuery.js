    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { ref: function ref(node) {
            return _this2.start = node;
          }, onChange: this.handleChange.bind(this), className: 'form-control', type: 'text', placeholder: 'min' }),
        _react2.default.createElement('input', { ref: function ref(node) {
            return _this2.end = node;
          }, onChange: this.handleChange.bind(this), className: 'form-control', type: 'text', placeholder: 'max' })
      );
    }
  }]);
  return RangeQuery;
