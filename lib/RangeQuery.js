  ...
  (0, _createClass3.default)(RangeQuery, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { className: 'form-control', type: 'text', onChange: this.props.updateMin, placeholder: 'min' }),
        _react2.default.createElement('input', { className: 'form-control', type: 'text', onChange: this.props.updateMax, placeholder: 'max' })
      );
    }
  }]);
  return RangeQuery;
...
var RangeQueryContainer = exports.RangeQueryContainer = function (_React$Component2) {
  ...
  (0, _createClass3.default)(RangeQueryContainer, [{
    ...
    value: function handleChange(ev) {
      ...
      var start = _.isEmpty(this.refs.start.value) ? null : this.refs.start.value;
      var end = _.isEmpty(this.refs.end.value) ? null : this.refs.end.value;
