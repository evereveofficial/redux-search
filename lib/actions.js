...
var fetcher = function fetcher(config) {
  return function (dispatch, state) {
    var searchQuery = (0, _reducers.querify)(state, config.searchId, config.dataSource.searchConfig);

    dispatch({ type: SEARCH_STARTED, id: config.searchId, searchQuery: searchQuery });
