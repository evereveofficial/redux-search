  ...
  (0, _createClass3.default)(RangeQuery, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("input", { className: "form-control", type: "text", ref: "start", onChange: this.handleChange.bind(this), placeholder: "min" }),
        _react2.default.createElement("input", { className: "form-control", type: "text", ref: "end", onChange: this.handleChange.bind(this), placeholder: "max" })
      );
    }
  }]);
  return RangeQuery;
