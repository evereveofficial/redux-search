...
var queryChange = function queryChange(onChange, header, ev) {
  var values = _lodash2.default.reject([ev.target.value], function (v) {
...
var LikeQuery = function (_React$Component2) {
  ...
  (0, _createClass3.default)(LikeQuery, [{
    ...
    value: function render() {
      return _react2.default.createElement('input', { className: 'form-control', type: 'text', onChange: this.handleChange.bind(this) });
    }
  }]);
  return LikeQuery;
}(_react2.default.Component);
...
var components = {
  like: LikeQuery,
  eq: EqQuery,
  range: _RangeQuery.RangeQueryContainer
};

var HeaderQuery = function (_React$Component4) {
  (0, _inherits3.default)(HeaderQuery, _React$Component4);
  ...
  (0, _createClass3.default)(HeaderQuery, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Query, (0, _extends3.default)({}, this.props, { header: header, query: header.query, onQueryChange: this.props.onQueryChange }));
    }
  }]);
  return HeaderQuery;
}(_react2.default.Component);
