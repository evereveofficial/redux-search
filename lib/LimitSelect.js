...
var LimitSelect = function (_React$Component) {
  ...
  function LimitSelect() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (LimitSelect.__proto__ || (0, _getPrototypeOf2.default)(LimitSelect)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(LimitSelect, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "select",
        { className: "form-control input-sm", onChange: this.handleChange.bind(this), defaultValue: this.props.search.limit },
        options
      );
    }
  }]);
